...
import org.mfl.models.{ApiResponseWithAllStationInformationData, ApiResponseWithAllStationStatusData, RecordFields, Row, StationInformation, StationInformationData, StationRecord, StationStatus, StationStatusData}
...
trait JsonSupport extends SprayJsonSupport with DefaultJsonProtocol {
	...
	implicit val recordFieldsFormat   :RootJsonFormat[RecordFields]                  = jsonFormat(
		...
		"nbfreedock",
		"nbbike")
	implicit val recordFormat   :RootJsonFormat[StationRecord]                  = jsonFormat(
		StationRecord,
		"fields",
		"record_timestamp")
